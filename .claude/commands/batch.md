...
- 文字数は基本150〜250字（狙いの女性フォロワーが増えた投稿の長さ。500字級は長すぎ）。長め深掘りは1バッチ1本まで
- テーマは自律神経・トラウマ・施術エピソード系を主軸に（雑学バズ狙いはしない）
- 1日10本を朝9〜夜23時に分散（`convert_tsv.py ... --per-day 10`）。早朝5〜9時の無人時間・短時間連投は避ける
